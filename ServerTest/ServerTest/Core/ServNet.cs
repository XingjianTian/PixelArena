...
public class ServNet
{
	...
	private void ProcessData(Conn conn)
	{
		...
		//消息长度
		Array.Copy(conn.readBuff, conn.lenBytes, sizeof(Int32));//source destination
	...
	private void HandleMsg(Conn conn, ProtocolBase protoBase)
	{
		...
		if (conn.player == null || name == "HeartBeat"|| name == "Logout") 
		{
			...
			mm.Invoke (handleConnMsg, obj); //MsgRegister(Conn conn,ProtocolBase protobase)
        }
		//角色协议分发
		else
		{
